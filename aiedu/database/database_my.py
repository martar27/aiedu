...
class DatabaseManager:
    def __init__(self, host='localhost', database='aiedu', user='root', password='', session_timeout=300, max_users=20, backup_interval=300):
        self.host = host
    ...
    def backup_database(self):
        ...
        try:
            backup_command = f"mysqldump -u {self.user} -p{self.password} {self.database} > {backup_path}"
